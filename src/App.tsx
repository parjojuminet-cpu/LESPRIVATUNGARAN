...
export default function App() {
  ...
  const loadAllData = async () => {
    ...
    try {
      ...
      if (Array.isArray(resAttendances)) setAttendances(resAttendances);
      if (Array.isArray(resInvoices)) setInvoices(resInvoices);
      if (Array.isArray(resFinance)) setFinance(resFinance);
      if (Array.isArray(resSalaries)) setSalaries(resSalaries);
      if (Array.isArray(resApprovals)) setApprovals(resApprovals);
